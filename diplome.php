...
require 'cnx.php';
session_start();
if(!isset($_SESSION['diplomeusername'])){
...
background: linear-gradient(to right, #EAEAEA, #DBDBDB, #F2F2F2, #ADA996)!important; /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
 ...
 <?php
 if($do == 'Attestation'){
 $show="SELECT diplome_student.id_student,diplome_student.Nom,diplome_student.Prenom,diplome_student.Email,filieres.nom FROM diplome_student INNER JOIN filieres on diplome_student.filliere = filieres.id_fil where id_student = '{$id}'" ;
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li class="active">
                ...
                <li>
                    <a href="diplome.php?action=proshow">voir Profile</a>
                </li>
                <li>
                    <a href="diplome.php?action=proedit">Modifier profile</a>
                </li>
	          ...
	          <li>
              <a href="diplome.php?action=absence"><i class='fas fa-book' style='font-size:18px;color:#f8b739'></i> Absence</a>
            </li>
	          <li>
              <a href="diplome.php?action=Attestation"><i class='fas fa-file-signature' style='font-size:18px;color:#f8b739'></i> Attestation</a>
            </li>
            <li>
              <a href="diplome.php?action=dmssg"><i class='fas fa-file-signature' style='font-size:18px;color:#f8b739'></i> Message du direction</a>
            </li>
            <li>
      ...
      <div id="content" class="p-4 p-md-5">
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="diplome.php?action=Attestation">Attestation</a>
                </li>
                <li class="nav-item">
        ...
        <div class="container">
          <div class="row">
           ...
           <div  class="col-md-6 ">
           <?php
            $show="SELECT * FROM diplome_student WHERE id_student = '{$id}'";
            $showsql=mysqli_query($cnx,$show);
            $row = mysqli_fetch_assoc($showsql);
            $do='';
            if(isset($_GET['action'])){
             ...
             <?php
              ...
              if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                $adminemail=$_POST['adminemail'];
                 $adminupdate = "UPDATE `diplome_student` SET `Nom` = '{$profnom}', `Prenom` = '{$profprenom}', `Email` = '{$adminemail}', `username` = '{$adminuser}', `password` = '{$adminpass}' WHERE `id_student` = {$adminid};";
